...
public class levelmanager : MonoBehaviour {
    ...
    void Awake()
    {
        ...
        if (instance.score > 200 && instance.currentLevelByInt == 1)
        {
            instance.LevelTwoOpened = true;
        }
        if (instance.score > 200 && instance.currentLevelByInt == 2)
        {
            instance.LevelThreeOpened = true;
        }
        if (instance.score > 200 && instance.currentLevelByInt == 3)
        {
